"""
src/ui/views/8_Remittance_Tracker.py
...
if df.empty:
    ...
    # Build a client ledger URL helper — links to the Client Ledger view
    def _ledger_url(client_name: str) -> str:
        import urllib.parse
        return f"?page=1_Client_Ledger&client={urllib.parse.quote(client_name)}"
    ...
    for _, row in df.iterrows():
        ...
        # Row header — client name is a link to ledger
        label = (
            f"{status_icon} "
